...
use App\Http\Middleware\FinalizeEdgeCacheHeaders;
...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        ...
        // Middleware GLOBAL de verdad (fuera del grupo `web`), para que
        // corra después de StartSession/EncryptCookies al desenrollar la
        // respuesta — ver el docblock de la clase para el porqué.
        $middleware->append(FinalizeEdgeCacheHeaders::class);
    })
