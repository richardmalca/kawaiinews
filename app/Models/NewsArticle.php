 ...
 */
#[Fillable(['news_cluster_id', 'author_id', 'title', 'slug', 'category', 'excerpt', 'body', 'featured_image', 'audio_url', 'audio_duration_seconds', 'dj_intro_url', 'dj_intro_duration_seconds', 'status', 'published_at'])]
