                    ...
                    <div className="space-y-4">
                        <div className="rounded-2xl border border-neutral-200/80 bg-neutral-50/50 p-4 dark:border-neutral-800/80 dark:bg-neutral-900/80">
                            ...
                            <ul className="mt-2 list-disc pl-5 text-xs text-neutral-600 dark:text-neutral-300 space-y-1">
                                <li><strong className="text-neutral-900 dark:text-white">Sesión:</strong> Mantiene tu usuario activo mientras navegas.</li>
                                <li><strong className="text-neutral-900 dark:text-white">Seguridad (CSRF Token):</strong> Protege tus envíos de formularios y comentarios contra ataques maliciosos.</li>
                                <li><strong className="text-neutral-900 dark:text-white">Preferencia visual:</strong> Guarda si elegiste modo oscuro o modo claro.</li>
                            </ul>
                        </div>
